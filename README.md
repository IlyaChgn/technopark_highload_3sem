...
- Согласно тестированию, которое было найдено на GitHub [14], четырехядерный процессор i5-7400 способен выдерживать до 630 RPS в простейшей задаче записи текста в тело HTTP-ответа. Это значит, что в более сложных задачах одно ядро процессора сможет обработать меньше. Возьмем в качестве примерного значения 80 RPS.
- Будем исходить из того, что на 1000 RPS необходимо 2 Гб RAM
...
|    Сервис     |    RPS    |    CPU    |    RAM    |
| ------------- | --------- | --------- | --------- |
| API gateway   | 8661      | 109       | 18 Гб     |
| video         | 883       | 12        | 2 Гб      |
| user          | 813       | 12        | 2 Гб      |
| auth          | 3753      | 47        | 8 Гб      |
| search        | 980       | 13        | 2 Гб      |
| comments      | 786       | 10        | 2 Гб      |
| ratings       | 793       | 10        | 2 Гб      |
| views         | 1570      | 20        | 2 Гб      |
| subscriptions | 788       | 10        | 2 Гб      |
| statistics    | 1626      | 21        | 4 Гб      |
| Nginx         | 19560     | 8         | 40 Гб     |
| Redis         | 1877      | 18        | 20 Гб     |
| PostgreSQL    | 566       | 12        | 50 Гб     |
| ElasticSearch | 486       | 7         | 50 Гб     |
| ClickHouse    | 1050      | 16        | 100 Гб    |
| Cassandra     | 546       | 16        | 50 Гб     |
...
- PostgreSQL - $43 500 + $723 амортизация
- Cassandra - $43 500 + $723 амортизация
...
| ------ | ------- | ------------ | ----- | ----- | ------- | ----------- |
| kubenode | own | 8xAMD EPYC 9124/16x32GB/1xNVMe1T/2x25Gb/s | 128 | 9 | $22000 | $500 |
| API gateway | own | 8xAMD EPYC 9124/16x32GB/1xNVMe1T/2x25Gb/s | 128 | 9 | $22000 | $500 |
| PostgreSQL | own | 2x6338/16x32GB/1xNVMe1T/2x25Gb/s | 64 | 3x9 | $14500 | $241 |
| ElasticSearch + Redis | own | 2x6338/16x32GB/1xNVMe1T/2x25Gb/s | 64 | 2x9 | $14500 | $241 |
| Cassandra | own | 2x6338/16x32GB/1xNVMe1T/2x25Gb/s | 64 | 3x9 | $14500 | $241 |
| ClickHouse | own | 2x6338/16x32GB/1xNVMe1T/2x25Gb/s | 64 | 3x9 | $14500 | $241 |
